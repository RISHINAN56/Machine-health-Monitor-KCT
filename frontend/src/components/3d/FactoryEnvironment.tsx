...
export const FactoryEnvironment: React.FC<FactoryEnvironmentProps> = ({
  ...
  const isCritical = machineStatus === "Critical";

  // AGV factory floor track coordinates
  const agvTrackPositions = useMemo(() => {
    return [
      // Main transport artery (parallel to machines)
      { start: [-14, 0.004, 3.2], end: [14, 0.004, 3.2] },
      { start: [-14, 0.004, -3.2], end: [14, 0.004, -3.2] },
      // Cross-bay connector tracks
  ...
  return (
    <group name="industrial-factory-environment">
      ...
      {/* Ground Contact Soft Shadows for Machine Grounding */}
      <ContactShadows
        position={[0, 0, 0]}
        opacity={0.85}
        scale={13}
      ...
      {/* ========================================================================= */}
      {/* 2. AGV (AUTOMATED GUIDED VEHICLE) FACTORY NAVIGATION TRACKS                */}
      {/* ========================================================================= */}
      ...
      {/* Overhead Crane Rails (Longitudinal Gantry Beams) */}
      ...
      {/* ========================================================================= */}
      {/* 6. OVERHEAD UTILITY DISTRIBUTION (CABLE TRAYS & PNEUMATIC PIPES)          */}
      {/* ========================================================================= */}
      {/* Cable Tray */}
      <group position={[0, 6.0, -4.8]}>
        ...
        {/* Yellow Compressed Air Distribution Main */}
        ...
        {/* Blue Technical Coolant / Process Line */}
        <mesh position={[0, 0.22, -0.15]} rotation={[0, 0, Math.PI / 2]}>
      ...
      {/* ========================================================================= */}
      {/* 7. DISTANT FACTORY HALL SILHOUETTES & PRODUCTION LINES                    */}
      {/* ========================================================================= */}
      {/* Distant Loom Row 1 (Far Left Bay 1) */}
      ...
      {/* Distant Loom Row 2 (Far Right Bay 3) */}
      <group position={[8.5, 0.8, -6.5]}>
        <mesh receiveShadow>
          <boxGeometry args={[3.6, 1.6, 2.0]} />
          <meshStandardMaterial color="#0b1329" metalness={0.8} roughness={0.5} />
      ...
      {/* Background Automated Storage & Retrieval Racks (High Bay Warehouse Outline) */}
