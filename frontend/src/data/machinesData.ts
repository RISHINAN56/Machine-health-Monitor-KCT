...
export function generateMachineTelemetryPacket(
  machineId: string,
  scenario: import("../types").SimulationScenario = "normal"
): import("../types").TelemetryPacket {
  const machine = REAL_WORLD_MACHINES[machineId] || REAL_WORLD_MACHINES.picanol;
  const isTsudakoma = machine.id === "tsudakoma";

  // Add realistic small brownian fluctuations
